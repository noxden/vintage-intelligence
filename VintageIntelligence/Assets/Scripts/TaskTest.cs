...
public static class TaskTest
{
    ...
    private static string _prompt = "Can you please convert the following text into a shakespearean dialect without adding any other response? " +
                                    " ";
    public static async Task TestingTask()
    {

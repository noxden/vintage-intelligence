...
//     version 1.5.1
//     from Assets/Scripts/Player/CavePlayerInput.inputactions
//
...
public partial class @CavePlayerInput: IInputActionCollection2, IDisposable
{
    public InputActionAsset asset { get; }
    public @CavePlayerInput()
    {
        asset = InputActionAsset.FromJson(@"{
    ""name"": ""CavePlayerInput"",
    ""maps"": [
        {
            ""name"": ""XRI Head"",
    ...
    {
        private @CavePlayerInput m_Wrapper;
        public XRIHeadActions(@CavePlayerInput wrapper) { m_Wrapper = wrapper; }
    ...
    {
        private @CavePlayerInput m_Wrapper;
        public XRILeftHandActions(@CavePlayerInput wrapper) { m_Wrapper = wrapper; }
    ...
    {
        private @CavePlayerInput m_Wrapper;
        public XRILeftHandInteractionActions(@CavePlayerInput wrapper) { m_Wrapper = wrapper; }
    ...
    {
        private @CavePlayerInput m_Wrapper;
        public XRILeftHandLocomotionActions(@CavePlayerInput wrapper) { m_Wrapper = wrapper; }
    ...
    {
        private @CavePlayerInput m_Wrapper;
        public XRIRightHandActions(@CavePlayerInput wrapper) { m_Wrapper = wrapper; }
    ...
    {
        private @CavePlayerInput m_Wrapper;
        public XRIRightHandInteractionActions(@CavePlayerInput wrapper) { m_Wrapper = wrapper; }
    ...
    {
        private @CavePlayerInput m_Wrapper;
        public XRIRightHandLocomotionActions(@CavePlayerInput wrapper) { m_Wrapper = wrapper; }
    ...
    {
        private @CavePlayerInput m_Wrapper;
        public XRIUIActions(@CavePlayerInput wrapper) { m_Wrapper = wrapper; }
